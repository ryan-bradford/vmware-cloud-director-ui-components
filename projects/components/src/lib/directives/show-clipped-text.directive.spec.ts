...
interface Test {
    ...
    eventToCallback: Map<string, () => void>;
}
...
fdescribe('ShowClippedTextDirective', () => {
    beforeEach(async function(this: Test): Promise<void> {
        ...
        /*this.eventToCallback = new Map();
        this.fixture.nativeElement.children[0].addEventListener = (event, callback) => {
            this.eventToCallback.set(event, callback);
        };*/
